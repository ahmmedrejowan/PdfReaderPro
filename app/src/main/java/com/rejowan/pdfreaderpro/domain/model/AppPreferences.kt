...
data class AppPreferences(
    ...
    val readerSnapEnabled: Boolean = false, // Snap to pages by default
    val readerScreenOrientation: ScreenOrientation = ScreenOrientation.AUTO // Screen orientation by default
)
